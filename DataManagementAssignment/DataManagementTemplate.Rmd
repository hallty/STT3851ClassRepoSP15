...
library(PDS)
library(dplyr)
addHealth.sub <- AddHealth %>% 
  select(H1FV8, H1FV7, H1FV5, H1DS14, H1DS12, H1DS10, H1DS9, H1DS8, H1DS6, H1DS5, H1DS4, H1DS2, H1DS1, H1TO44, H1TO36, H1TO28, H1TO27, H1TO23, H1TO22, H1TO20, H1TO18, H1TO17, H1TO15)
dim(addHealth.sub)
